...
# 기본 수집 키워드 — 페르소나 관심 키워드가 없을 때의 폴백.
# 과거 ("AI", "자동화")는 너무 광범위해 조선/제조와 무관한 기사(바둑 AI 등)가
# 대량 혼입됐다 → 조선소 AI·자동화 도메인에 앵커링한 키워드로 교체.
# (개별 사용자는 페르소나 관심 키워드로 자동 대체된다 — api/routers/collect.py)
